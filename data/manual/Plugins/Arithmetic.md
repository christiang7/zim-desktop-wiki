...
## Plugin options
The option **Output precision** sets the maximum number of decimals shown in the output; extraneous decimals aren't shown. The precision of the underlying [`decimal`](https://docs.python.org/3/library/decimal.html) library is always set to 100 places.
