...
Mail [me](jaap.karssenberg@gmail.com) if you have questions that you would like to see answered below.
...
Zim notebooks do not support encryption or password protection natively. However, you can use for example [encfs](https://www.arg0.net/encfs) to encrypt your notebooks.
...
## Does it run on OS X?
Yes, it does. See the install instructions on our [webpage](https://zim-wiki.org/install.html), or check in the [zim documentation wiki](https://www.zim-wiki.org/wiki/) for additional tips how to install it.
...
You can have a look at the [zim documentation wiki](https://www.zim-wiki.org/wiki/). It has a section dedicated to tricks and tips. And you can post in the "show and tell" section of discussion forum at <https://github.com/zim-desktop-wiki/zim-desktop-wiki/discussions>.
