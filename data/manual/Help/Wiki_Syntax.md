...
Most of this syntax is inspired by the [DokuWiki syntax](https://www.dokuwiki.org/wiki:syntax), but with some significant modifications. All markup uses at least two characters to reduce the chance of conflicts between the wiki markup normal typographic use of these characters.
