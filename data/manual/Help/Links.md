...
Finally there is a special "anchor" object to place a link anywhere in the text or to e.g. set an explicit id for a heading. This can be inserted by typing "`##name`" and is rendered like this: {#name} .
